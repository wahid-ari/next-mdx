    ...
    <nav className="sticky top-0 z-10 bg-white dark:bg-neutral-900 shadow dark:border-b dark:border-b-neutral-800">
      <div className="max-w-5xl py-4 px-2 mx-auto flex flex-wrap gap-4 justify-between">
        ...
        <div className="flex flex-wrap items-center gap-x-5 gap-y-3">
          <ThemeChanger simple />
          <a href={process.env.REPO_URL} aria-label="github" target="_blank" rel="noopener noreferrer" className="text-sky-500 hover:text-sky-600 transition-all text-sm font-medium cursor-pointer">
