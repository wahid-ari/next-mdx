  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-5xl px-2 min-h-screen 
          ...
          prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:before:hidden prose-code:after:hidden dark:prose-code:bg-[#191919] prose-code:bg-neutral-100
          prose-pre:m-0 prose-pre:p-2 dark:prose-pre:bg-[#191919] prose-pre:bg-neutral-100
