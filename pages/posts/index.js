...
export default function Posts({ posts }) {
  ...
  return (
    <>
      ...
      <div className="dark:bg-neutral-900 min-h-screen p-4">
        <h1 className="text-center py-10 text-4xl dark:text-white font-bold">Posts</h1>
        <div className="mx-auto max-w-3xl relative w-full mb-4">
          <input
            aria-label="Search posts"
            type="text"
            onChange={(e) => setSearchValue(e.target.value)}
            placeholder="Search posts"
            className="block w-full px-4 py-2 text-gray-900 bg-white border border-gray-200 rounded-md dark:border-gray-900 focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-800 dark:text-gray-100"
          />
          <MagnifyingGlassIcon className="absolute w-5 h-5 text-gray-400 right-3 top-3 dark:text-gray-300"/>
        </div>
        <div className="mx-auto max-w-3xl py-4 grid sm:grid-cols-2 gap-6">
          {searchValue ?
