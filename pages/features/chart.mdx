...
<Head>
	<title>Chart</title>
	<meta name="title" content="Chart"></meta>
	<meta name="description" content="Chart"></meta>
</Head>

# Chart

Using [**react-chartjs-2**](https://react-chartjs-2.js.org/) React components for [Chart.js](https://www.chartjs.org/), the most popular charting library.
...
<BarChart />
```
<div className="sm:w-[34rem] pt-4 mx-auto">
	<BarChart />
</div>
