...
import Framework, {Item} from '@components/Framework'
import Head from "next/head";

<Head>
	<title>Features</title>
	<meta name="title" content="Features"></meta>
	<meta name="description" content="Features"></meta>
</Head>

{
// wrapped with {} to mark it as javascript so mdx will not put it under a p tag
}
{<h1 className="text-center font-extrabold md:text-5xl">SWR</h1>}
...
<div className="mt-16 mb-20 text-center">
  [Get Started](/docs) · [Libs](/libs/sandpack) · [Blog](/blog) · [GitHub Repository](https://github.com/vercel/swr)
</div>
